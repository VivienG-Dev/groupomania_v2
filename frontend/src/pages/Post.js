            ...
            <Card.Body>
              <div className="post">
                <span className="fw-light">
                  <img src={authState.userImage} height="25" className="d-inline-block align-top" /> {postObject.firstname} Date: {newDatePost}
                </span>
                  ...
                  {listOfcomments &&
                    ...
                    listOfcomments.map((comment, index) => {
                      ...
                      return (
                        ...
                        >
                          <span className="fw-light">
                            <img src={authState.userImage} height="25" className="d-inline-block align-top" /> {comment.firstname} Date: {newDateComment}
                          </span>
