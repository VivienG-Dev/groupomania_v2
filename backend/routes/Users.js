...
router.post("/login", async (req, res) => {
  ...
  bcrypt.compare(password, user.password).then((valid) => {
    ...
    const accessToken = sign(
      { email: user.email, userImage: user.userImage, firstname: user.firstname, lastname: user.lastname, id: user.id, isAdmin: user.isAdmin },
    ...
    res.json({ token: accessToken, email: email, userImage: user.userImage, firstname: user.firstname, lastname: user.lastname, id: user.id, isAdmin: user.isAdmin });
  });
});
